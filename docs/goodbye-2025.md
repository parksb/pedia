...
인류가 인간 수준의 인공지능을 만들어내는 데 얼마나 가까워졌는지 판단하기 위해 시간을 거슬러 올라가 최초의 뇌를 조사하고, 인간의 지능이 어떻게 발전했는지 재구성해본다.
...
플랫폼 엔지니어링은 플랫폼을 개발하고 운영하는 특정 분야다. 이 분야의 목표는 비즈니스에 레버리지를 전달하기 위해 전체 시스템의 복잡성을 관리하는 것이다.

실무 가이드라는 측면보다는, 플랫폼 엔지니어로서 마인드셋을 만드는데 많은 도움이 됐다. 사실 이 책을 읽기 전까지 애플리케이션 개발자가 플랫폼의 고객이라는 인식이 부족했다.

### [[history-immediately-after-liberation-in-1945]]

현대 한국이 기원하는 결정적인 시기였음에도 불구하고, 해방 직후 어떤 일이 있었는지는 잘 알려져 있지 않다.

고립된 조선총독부와 무능한 미군정, 그리고 친미-반공-기독교-엘리트 조선인들이 빚어낸 역사. 오늘날 한국의 보수주의가 이들로부터 출발했다는 사실과 아직도 이들로부터 정통성을 찾고 있다는 사실이 비극이다.

### [[justifying-injustice]]

당대 가장 민주적이었던 바이마르 헌법이 어떻게 합법적으로 나치를 등장시켰고, 나치에 부역한 법률가들이 어떻게 국가폭력을 정당화했는지 면밀히 살펴본다.

법과 도덕의 경계가 사라지고, 법률이 개인의 일상에 파고드는 순간이 곧 국가가 모든 개인을 통제하는 순간으로 이어진다. 그리고 그 안에서 소극적으로 저항한 법률가들 역시, 결국 나치의 법 질서에서 벗어나지 않았음을 명확히 비판하는 부분이 인상적이었다. 여러모로 2025년 초에 시기적절한 독서였다.
...
### [슬로우뉴스 컨텍스트 레터](https://slownews.kr/category/slowletter)

매일 아침 슬로우뉴스 뉴스레터를 읽으며 출근했다. 뉴스레터는 이정환 대표가 매일 새벽 4시에 일어나 10종의 신문을 읽고 기사를 정리해 7시에 발송한다. '쉽게' 뉴스를 전해준다는 뉴스 큐레이션 서비스들이 [[neutrality-myth]]{언론의 객관성이라는 신화}에 빠져서 논점을 놓칠 때, 슬로우뉴스는 해석을 제시한다.

뉴스레터에 실렸던 [역발상 전세 사기 해법, 집 주인이 대출 받게 만들어 보자](https://slownews.kr/128251) 기사에서는 사금융의 영역에 있는 [[jeonse]] 제도를 전세금융공사(가칭)라는 공사를 통해 제도권에 편입하자는 세종대학교 임재만 교수의 제안을 소개했다. 문제 의식에 공감했고, 대안도 설득력이 있었다. 
...
### [Web Framework 팀을 선택한 이유, 플랫폼 엔지니어 도전기](https://toss.im/career/article/web_framework_2511)

내가 쓴 글은 아니지만, 나를 인터뷰한 글이 회사 채용 아티클로 발행되었다. 웹 프레임워크 팀을 소개하면서 내가 왜 백엔드 개발자에서 학교로, 학교에서 프론트엔드 플랫폼 엔지니어로 커리어를 전환했는지에 대한 이야기를 담았다.
...
개인의 삶과 시대가 연결되는 지점을 탁월하게 그려낸 영화. 연출과 스토리도 흥미로운데, 그 안에 주제 의식을 자연스럽게 녹여냈다. [[well-made-film]]{내가 생각하는 좋은 영화}의 특성을 가지고 있어서 너무나 재미있게 봤다. 마지막 차량 추격씬의 연출도 놀라웠다.
...
AKB48이 쇼와 시대, 헤이세이 시대, 레이와 시대 아이돌 음악을 커버한 앨범. 뜬금없지만 어쩌다보니 예비군 훈련 왔다갔다하는 4일간 반복 재생했다. "行くぜっ!怪盗少女(가자! 괴도소녀)", "LOVEマシーン(러브머신)"의 어처구니없는 MV와 가사에서 기묘한 노스탤지어가 느껴진다. 新しい学校のリーダーズ(새로운 학교의 리더즈)를 알게 된 것은 이 앨범을 통한 큰 수확이었다.
...
올해도 즐겁게 했다. 회사 플레이샵에서 "컨베이어 벨트가 만드는 무한한 즐거움"이라는 제목으로 발표도 했다.
...
연말에 5박6일 여행을 다녀왔다. 구체적인 계획없이 남쪽에 숙소 하나를 잡고, 매일 한 지역을 골라서 하루종일 그곳에서 시간을 보냈다. 제주의 남쪽은 정말 따뜻했다. 이번 여행의 테마는 여유였는데, 5일차에 독감에 걸려버렸다. 병원에서 타미플루를 맞고 새해를 맞이했다.
...
해커를 위한 연합우주 소셜 네트워크 서비스. Hackers' Pub이 서비스를 시작한 이후 연함우주 참여자가 크게 늘어서 피드가 풍성해졌다. 내가 연합우주 피드를 지속적으로 들어오게 만들어주는 고마운 커뮤니티다. 사실 나는 아직 계정이 없다.

## 올해의 내 프로젝트

### [Simpesys](https://github.com/parksb/simpesys)

Simonpedia의 문서 빌드 시스템을 일반화해서 별도의 도구로 배포했다.
...
회사에서 Yarn을 사용하면서 마주한 문제를 직접 수정했고, 컨트리뷰터가 되었다. 한동안 정체되어 있다는 느낌을 받다가 오랜만에 오픈소스 기여를 하니 즐거웠다. 그리고 이게 회사 업무의 일환이라는 것도 이 일을 좋아하게 만든다.

### [[knip]]

- [#1361 Support Yarn PnP](https://github.com/webpro-nl/knip/pull/1361)

Yarn PnP를 지원하지 않는 도구가 정말 많다. 회사 모노리포에서 다른 분이 패치해주신 버전을 사용하고 있었는데, 커뮤니티의 지속적인 지원을 받기 위해 업스트림에 PR을 열었다.

### [yarn-plugin-catalogs](https://github.com/toss/yarn-plugin-catalogs)

PNPM의 카탈로그 기능을 Yarn에서도 사용하기 위해 만든 플러그인. 사내 [[monorepo]]를 관리하기 위해 만든 플러그인이라서 PNPM 카탈로그와 달리 많은 추가 기능을 제공한다. Yarn이 4.10.0 버전부터 카탈로그를 공식적으로 지원하면서 위치가 좀 애매해졌는데, Yarn의 카탈로그를 확장하는 역할로 전환했다.
...
- 팀 플레이샵에 참석했다. 어쩌다보니 팀원들과 BL 웹툰 콜라보 카페를 갔다. 일하는 분이 "여기는 보통 카페가 아닌데 괜찮으시겠어요?"라고 물어보셔서 '뭐가 있길래 괜찮냐는거지?' 싶었는데... 2층에 올라가보니 이해했다.
- 10년 살아온 집을 떠나 산골 전원주택으로 이사했다.
  - 아파트가 아닌 곳에 산다는게 여전히 낯설다. 전원 생활은 대단히 좋은 한 가지를 위해 아흔 아홉 가지 사소한 불편을 참아야 한다.
  - 출퇴근 시간이 worst case 40분 정도 늘어서 주말마다 부동산을 돌아다녔다.
