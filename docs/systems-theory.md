...
시스템 이론은 시스템(상호 연관된 구성 요소들의 집합)에 대한 연구 분야다. 산업혁명 이후 서구 사회는 복잡한 사물을 하위 단계로 세분화하는 [[reductionism]]적 접근을 통해 대상을 이해했다. 시스템 이론은 이러한 방식에서 벗어나 전체를 구성하는 요소 간의 상호작용에 초점을 맞춘다.
