...
- :book: **Albert P. Malvino, "Digital Computer Electronics", 1977**
  - 트랜지스터와 다이오드로 논리 게이트를 만드는 것으로 시작해서 SAP(Simple-As-Possible) 컴퓨터를 만드는 여정.
...
- 위키를 다시 정비했다. <[[how-to-take-smart-notes]]>를 읽고 메모를 열심히 썼다.
...
- **첫 출근을 했다.**
- 오랜만에 팩토리오를 열심히 했다. [[goodbye-2019]]{2019년}에 친구들과 했던 멀티플레이 서버와 비교하면 규모는 작지만, 설계는 좀 더 만족스럽다.
